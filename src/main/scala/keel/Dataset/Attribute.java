 ...
 * maximums, etc. It offers a collection of functions to get all this
 * information.
 *
...
public class Attribute implements java.io.Serializable {
	...
	/**
	 * Label to identify attributes that hasn't been defined neither as input or
	 * output
	 */
	...
	/**
	 * It indicates if the attribute is an input (0), an output (1) or has not
	 * been defined neither as input or output (-1)
	 */
	private int dirAttribute;

	/**
	 * It keeps the type of the attribute. It can be one of the following
	 * values: [Attribute.Nominal, Attribute.Integer, Attribute.Real]
	 */
	private int type;
	...
	/**
	 * Vector where all the values that can take this nominal attribute are
	 * going to be stored.
	 */
	...
	/**
	 * Flag that indicates if it's the first time that an operation is made with
	 * the current attribute.
	 */
	private boolean firstTime;

	/**
	 * It indicates if the bounds of the attribute has been fixed in its
	 * definition.
	 */
	...
	/**
	 * It informs that a nominal value not compresed in train list values has
	 * been read in test
	 */
	...
	public void setType(int _type) {
		...
		// If type is nominal, a new vector has to be created to store the list
		// of
	 ...
	 * 
	 * @param _min
	 *            is the minimum value that the attribute can take.
	 * @param _max
	 *            is the maximum value that the attribute can take.
	 */
	 ...
	 * 
	 * @param fBounds
	 *            is the value that has to be fixed to fixedBounds.
	 */
	 ...
	 * 
	 * @param value
	 *            is the value read from the BD file
	 */
	public void enlargeBounds(double value) {
		...
		if (firstTime) {
			// If it's the first attribute update and the bounds are not fixed
			// in its
	...
	/**
	 * It update an integer or real value read for an attribute in the test set
	 * if it doesn't match with the bounds defined in the train set. In this
	 * case, it replaces the value read for the nearliest bound (the minimum or
	 * the maximim bound respectively)
	 * 
	 * @param value
	 *            is the value read from the test file.
	...
	/**
	 * It does check if the value passed as an argument is bounded by the [min,
	 * max] interval.
	 * 
	 ...
	 * 
	 * @param whichClass
	 *            is the class which is wanted to know the most frequent value.
	 * @return a String with the most used value.
	 */
	public String getMostFrequentValue(int whichClass) {
		if (!makeStatistics || type != NOMINAL || mostUsedValue == null)
			return null;
		if (whichClass < 0 || whichClass >= mostUsedValue.length)
			return null;
	 ...
	 * 
	 * @param whichClass
	 *            is the integer value for the class
	 * @return a double with the mean value.
	 */
	public double getMeanValue(int whichClass) {
		if (!makeStatistics || (type != REAL && type != INTEGER)
				|| meanValue == null)
			return 0;
		if (whichClass < 0 || whichClass >= meanValue.length)
			return 0;
	 ...
	 * 
	 * @param whichClass
	 *            is the class which frequency has to be increased
	 * @param value
	 *            is the nominal value which frequency has to be increased.
	 */
	 ...
	 * 
	 * @param whichClass
	 *            is the class where to add the new value
	 * @param value
	...
	/**
	 * It returns the number of different values that can take a nominal
	 * attribute.
	 * 
	 * @return an int with the number of different values that can take a
	 *         nominal attribute.
	 */
	 ...
	 * 
	 * @param pos
	 *            indicate which attribute value is wanted.
	 ...
	 * 
	 * @param value
	 *            is the value that is wanted to be converted
	 ...
	 * 
	 * @param attr
	 *            is the second attribute of the comparation.
	 ...
	 * 
	 * @param _dirAtt
	 *            is the direction (input/output) of the attribute.
	 */
		...
		if (type == NOMINAL) {
			if (mostUsedValue != null) {
				...
				for (int i = 0; i < mostUsedValue.length; i++) {
					...
					System.out
							.println("  ("
									+ classFrequencies[i][convertNominalValue(mostUsedValue[i])]
									+ ").");
				}
			}
