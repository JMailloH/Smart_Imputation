...
public class InstanceSet {
	 ...
	 */
	private static InstanceAttributes attributes;
	...
	public static InstanceAttributes getAttributeDefinitions() {
		return attributes;
	 ...
	 *            a test.
	 */
	public void readSet(ArrayList<String> instances, boolean isTrain)
			throws DatasetException, HeaderFormatException {
	 ...
	 *            a test.
	 */
	public void readSet(ArrayList<String> instances, boolean isTrain, InstanceAttributes atts)
			throws DatasetException, HeaderFormatException {
	...
	public void parseHeaderFromString(String[] cabecera, boolean isTrain) {
	...
	public void parseHeaderFromString(ArrayList<String> cabecera,
			boolean isTrain) {
		// 1. Declaration of variables
		Vector inputAttrNames = new Vector();
		Vector outputAttrNames = new Vector();
