...
public class Main {
	 ...
	 public static void printHelp() {
	        ...
	        System.err.println();
	        System.err.println("--------------");
	        System.err.println("-t <training INPUT file> -T <test INPUT file> -o <training OUTPUT file> -O <test OUTPUT file> -k <number of neighbors for WKNNI>");
	        System.err.println();
	    }
        ...
        if (args.length == 1){
        	...
        	if(args.length == 0){
	        	...
	        	try {
		        	...
		        	M = new wknnImpute(input_tra,input_tst,output_tra,output_tst,neighbors);
	        	} catch (OptionException e) {
	                System.err.println("Error found. Check option(s) " + e.options() + " requeriments.");
